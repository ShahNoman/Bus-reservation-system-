...
<?php
	...
	$gen = new general; 
	$table_data = $gen->table_data('user_tbl','where user_type = "manager"',"order by user_id asc","");
...
table tr th
{
	...
	<h1  style=" text-align:center;padding-top:50px;"> Manager Detail </h1>
...
<tr style="border-bottom:1px solid #000;">
	...
	<?php echo $each_row['date_birth'] ?>
		...
		<a onClick="return confirmation();" href="<?php echo ADMIN_URL.'manager.php?delete='.$each_row['user_id'] ?>"><img src="image/delete.png"></a>
		</td>
