...
<?php
	...
	$gen = new general; 
	$table_data = $gen->table_data('user_tbl','where user_type = "staff"',"order by user_id asc","");
...
table tr th
{
	...
	<h1  style="text-align:center;margin-top:0px;padding-top:50px;"> Staff Detail </h1>
...
<tr style="border-bottom:1px solid #000;">
	...
	<td style="background-color:#FFFFFF;height:50px;width:150px;border-color:#ECF5ED;">
	<img src="image/<?php echo $each_row['user_photo']; ?>" style="max-width:150px;">
	</td>
...
<td style="background-color:#FFFFFF;height:50px;width:150px;border-color:#ECF5ED;">
	...
	<td style="background-color:#FFFFFF;height:50px;width:150px;border-color:#ECF5ED;">
		...
		<a onClick="return confirmation();" href="<?php echo ADMIN_URL.'staff.php?delete='.$each_row['user_id'] ?>"><img src="image/delete.png"></a>
		</td>
