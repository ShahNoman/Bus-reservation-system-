...
<table style="border-bottom:2px solid #ECF5ED;border-right:2px solid #ECF5ED; width:1100px;margin:0 auto;border-radius:10px;">	
	...
	<tr>
	<th style="background-color:#ECF0F5;height:50px;width:150px;border-color:#ECF5ED;">Customer name</th>
...
<th style="background-color:#ECF0F5;height:50px;width:150px;border-color:#ECF5ED;">	Customer Fullname</th>
	...
	<div style="width:300px; height:60px;margin:0 auto;">
		...
		<a href="<?php echo  CUSTOMER_URL.'edit.php?user_id='.$_SESSION['webapp']['user']['user_id'] ?>" style="text-decoration:none;"><h1>UPDATE PROFILE</h1></a>
